...
void NGLScene::paintGL()
{
  ...
  m_sph->draw(mvp, m_camera.getEye().toVec3(),m_textureID);
  ...
  /*if (m_displayParticles)
  {
    ...
    m_particleEmitter->draw(mvp, m_camera.getEye().toVec3());
  }

  if (m_displayVectorField)
  {
    m_vectorField->draw(mvp);
  }
