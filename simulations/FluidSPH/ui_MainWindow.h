...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        m_quadViscosity->setGeometry(QRect(0, 300, 94, 31));
        ...
        m_stiffness->setGeometry(QRect(0, 360, 94, 31));
        ...
        m_nearStiffness->setGeometry(QRect(0, 420, 93, 31));
        ...
        m_gravity->setGeometry(QRect(0, 480, 76, 31));
